...
### 5.3 Trânsito sintético correlacionado com tipo de via
...
### 6.4 Dijkstra Bidirecional (algoritmo adicional)
...
## 7. Experimentos e principais resultados

### 7.1 Comparação dos 4 algoritmos (A para B sem caminhada, peso `travel_time`)
...
### 7.2 Cenário com trânsito sintético
...
### 8.1 Como o problema foi modelado como grafo?
...
### 8.2 O que representam os nós e as arestas?
...
### 8.4 Como o trânsito sintético alterou as rotas?
...
### 8.5 Caminhar alguns metros melhorou a solução?
...
### 8.6 Em quais casos caminhar atrapalhou?
...
### 8.7 A menor distância foi também a rota mais rápida?
...
### 8.8 O A* expandiu menos nós que o Dijkstra?
...
### 8.9 O Dijkstra com Heap foi mais eficiente que o Dijkstra simples?
...
### 8.10 O algoritmo da literatura trouxe algum ganho?
...
### 8.11 Quais limitações existem na modelagem proposta?
...
### 8.12 Como o modelo poderia ser aproximado de um aplicativo real de mobilidade?
